...
namespace DNANeuralNet
{
    public class DNALayer
    {
        ...
        public DNAMatrix CalculateOutputs(DNAMatrix inputs, DNALayerLearnData learnData)
        {
           ...
           // Debug.Log("Inputs Height: " + inputs.Height);
           // Debug.Log("Inputs Width: " + inputs.Width);

           // Debug.Log("Weight Height: " + weights.Height);
           // Debug.Log("Weight Width: " + weights.Width);

           // Debug.Log("Bias Height: " + biases.Height);
           // Debug.Log("Bias Width: " + biases.Width);
