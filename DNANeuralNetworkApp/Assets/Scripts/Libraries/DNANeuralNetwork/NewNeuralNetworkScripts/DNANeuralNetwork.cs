    ...
    public class DNANeuralNetwork
    {
        ...
        public DNANeuralNetwork(int[] layerSizes)
        {
            ...
            for (int i = 0; i < layers.Length; i++)
            {
                ...
                //Debug.Log("Weight Height:" +layers[i].weights.Height);
               // Debug.Log("Weight Width:" + layers[i].weights.Width);


               // Debug.Log("Bias Height:" + layers[i].biases.Height);
               // Debug.Log("Bias Width:" + layers[i].biases.Width);
            }
